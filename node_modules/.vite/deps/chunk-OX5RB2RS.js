  ...
  connect(e2) {
    return new Promise(((n2, r3) => et(this, void 0, void 0, (function* () {
      ...
      try {
        ...
        i2 && (window.onWebWalletConnect = h2), this.connector = new esm_default4({ bridge: this.bridge || s2 || "https://bridge.walletconnect.org", qrcodeModal: kt({ isWebWalletAvailable: i2, shouldDisplayNewBadge: l2, shouldUseSound: u2, compactMode: this.compactMode, promoteMobile: c2, singleAccount: this.singleAccount, selectedAccount: null == e2 ? void 0 : e2.selectedAccount }) }), yield this.connector.createSession({ chainId: this.chainId || 4160 }), (function(t, e3) {
          var n3, r4, o4, i3;
  ...
  reconnectSession() {
    return new Promise(((e2, n2) => et(this, void 0, void 0, (function* () {
      ...
      try {
        ...
        })()) || void 0 === r3 ? void 0 : r3.bridge) || "", this.bridge && (this.connector = new esm_default4({ bridge: this.bridge }), e2((null === (o3 = this.connector) || void 0 === o3 ? void 0 : o3.accounts) || [])), this.isConnected || e2([]);
      } catch (t) {
  ...
  signTransaction(t, n2) {
    return et(this, void 0, void 0, (function* () {
      ...
      const r3 = t.flatMap(((t2) => t2.map(((t3) => (function(t4, n3) {
        ...
        const o3 = { txn: (i2 = t4.txn, Buffer.from(esm_default.encodeUnsignedTransaction(i2)).toString("base64")) };
        var i2;
...
"undefined" != typeof window && (window.global = window, window.Buffer = window.Buffer || y, import("./App-428f5096-WUNORAUK.js"));
...
bowser/src/bowser.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-OX5RB2RS.js.map
